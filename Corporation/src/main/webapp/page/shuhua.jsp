  ...
  <ul id="MenuBar1" class="Menu">
	...
	<div class="left">
        <ul class="association">
            <li><span  onClick="show('d1')"><img src="images/shuhua.png" class="left_logo" />协会介绍</span></li>
            <li><span  onClick="show('d2')"><img src="images/shuhua.png" class="left_logo"/>名&nbsp;人&nbsp;堂</a></li>
            <li><span  onClick="show('d3')"><img src="images/shuhua.png" class="left_logo"/>协会相册</span></li>
            <li><span  onClick="show('d4')"><img src="images/shuhua.png" class="left_logo"/>协会部门</span></li>
            <li><span  onClick="show('d5')"><img src="images/shuhua.png" class="left_logo"/>协会活动</span></li>
            <li><span  onClick="show('d6')"><img src="images/shuhua.png" class="left_logo"/>协会文档</span></li>
            <li><span  onClick="show('d7')"><img src="images/shuhua.png" class="left_logo"/>活动报名</span></li>
            <li><span  onClick="show('d8')"><img src="images/shuhua.png" class="left_logo"/>活动赞助</span></li>
            <li><span  onClick="show('d9')"><img src="images/shuhua.png" class="left_logo"/>会员缴费</span></li>
            <li><span  onClick="show('d10')"><img src="images/shuhua.png" class="left_logo"/>留&nbsp;言&nbsp;区</span></li>
        </ul>
    </div>
    <div class="right">
    <!--------------------------------------------------协会介绍--------------------------------------------------------------->
