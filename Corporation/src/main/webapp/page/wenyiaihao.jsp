  ...
  <ul id="MenuBar">
	...
	<div class="left">
        <ul class="association">
            <li onClick="data()"><span  onClick="show('d1')"><img src="images/wenyiaihao.png" class="left_logo" />协会介绍</span></li>
            <li><span  onClick="show('d2')"><img src="images/wenyiaihao.png" class="left_logo"/>名&nbsp;人&nbsp;堂</a></li>
            <li><span  onClick="show('d3')"><img src="images/wenyiaihao.png" class="left_logo"/>协会相册</span></li>
            <li><span  onClick="show('d4')"><img src="images/wenyiaihao.png" class="left_logo"/>协会部门</span></li>
            <li><span  onClick="show('d5')"><img src="images/wenyiaihao.png" class="left_logo"/>协会活动</span></li>
            <li><span  onClick="show('d6')"><img src="images/wenyiaihao.png" class="left_logo"/>协会文档</span></li>
            <li><span  onClick="show('d7')"><img src="images/wenyiaihao.png" class="left_logo"/>活动报名</span></li>
            <li><span  onClick="show('d8')"><img src="images/wenyiaihao.png" class="left_logo"/>活动赞助</span></li>
            <li><span  onClick="show('d9')"><img src="images/wenyiaihao.png" class="left_logo"/>会员缴费</span></li>
        </ul>
    </div>
    <div class="right">
    <!--------------------------------------------------协会介绍--------------------------------------------------------------->
   	  <div class="clubrightshow" id="d1">
      	<h2 style="text-align:center; margin-top:20px; margin-bottom:20px;padding-right:30px;">协会简介</h2>
      	<p id="cintroduce">${cor.cintroduce}</p>  
      	<p>${cor.cname}</p> 
      </div>
