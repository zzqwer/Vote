...
public class Users {
	...
	public Users(int usid, String username, String password, int age, String sex, String email, String home,
			String userclass, String phone, String pic) {
		this.usid = usid;
		this.username = username;
		this.password = password;
		this.age = age;
	...
	public String toString() {
		return "\n\tUsers [usid=" + usid + ", username=" + username + ", password=" + password + ", age=" + age
				+ ", sex=" + sex + ", email=" + email + ", home=" + home + ", userclass=" + userclass + ", phone="
				+ phone + ", pic=" + pic + "]";
	}
